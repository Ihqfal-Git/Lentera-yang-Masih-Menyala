...
export const STORY_CONTENT = {
  ...
  phase2: {
    ...
    mosaic: {
      title: 'Kepingan yang Tersimpan',
      prompt: 'Sentuh setiap fragmen untuk menjernihkan ingatan',
      ...
      photos: [
        ...
        },
        {
          ...
          label: 'Fragmen II',
          imageSrc: '/assets/memories/mem-02.jpg',
          caption: 'Di balik lelahnya masa ujian akhir saat itu, ada perjuangan dan ketulusanmu yang diam-diam selalu kudoakan.',
        },
        {
          id: 3,
          label: 'Fragmen III',
        ...
        },
        {
          ...
          caption: 'Hari perpisahan saat itu, kamu tampil begitu anggun dan berbeda dari hari-hari biasa.',
        },
      ],
    },
